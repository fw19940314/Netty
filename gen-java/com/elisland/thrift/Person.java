...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField IS_STUDENT_FIELD_DESC = new org.apache.thrift.protocol.TField("isStudent", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean isStudent; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    AGE((short)1, "age"),
    NAME((short)2, "name"),
    IS_STUDENT((short)3, "isStudent");
  ...
  private static final int __ISSTUDENT_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.AGE,_Fields.NAME,_Fields.IS_STUDENT};
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_STUDENT, new org.apache.thrift.meta_data.FieldMetaData("isStudent", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public Person setIsStudent(boolean isStudent) {
    ...
    setIsStudentIsSet(true);
    return this;
  }

  public void unsetIsStudent() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ISSTUDENT_ISSET_ID);
  }

  /** Returns true if field isStudent is set (has been assigned a value) and false otherwise */
  public boolean isSetIsStudent() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ISSTUDENT_ISSET_ID);
  }

  public void setIsStudentIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ISSTUDENT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IS_STUDENT:
      if (value == null) {
        ...
        setIsStudent((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_isStudent = true && this.isSetIsStudent();
    boolean that_present_isStudent = true && that.isSetIsStudent();
    if (this_present_isStudent || that_present_isStudent) {
      if (!(this_present_isStudent && that_present_isStudent))
        return false;
      if (this.isStudent != that.isStudent)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIsStudent()) ? 131071 : 524287);
    if (isSetIsStudent())
      hashCode = hashCode * 8191 + ((isStudent) ? 131071 : 524287);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsStudent()).compareTo(other.isSetIsStudent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsStudent()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isStudent, other.isStudent);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // IS_STUDENT
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isStudent = iprot.readBool();
              struct.setIsStudentIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIsStudent()) {
        oprot.writeFieldBegin(IS_STUDENT_FIELD_DESC);
        oprot.writeBool(struct.isStudent);
        oprot.writeFieldEnd();
      }
